// public/js/print_educational_attainment_table.js
document.addEventListener("DOMContentLoaded", function () {
  const printBtn = document.getElementById("printEducationalAttainmentTable");
  const table = document.getElementById("educationTable"); // your modal table id is educationTable
  ...
  printBtn.addEventListener("click", () => {
    ...
    // Only print visible rows (after filter/search)
    ...
    newWin.document.write(`
      <html>
      <head>
        <title>Educational Attainment Records</title>
