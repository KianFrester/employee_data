    ...
    <div class="row g-4"> 
        ...
        <div class="col-md-6">
            <div class="card shadow rounded-4">
                <div class="card-header text-white text-center fw-bold fs-5 rounded-top-4" style="background-color: #16166c;">
                ...
                <div class="card-body text-center">
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="bg-info text-white fs-4 fw-bold py-4 rounded">Total Employees: 10</div>
                        </div>
                        <div class="col">
                            <h6 class="fw-bold">FEMALE</h6>
                            <div class="text-white fs-4 fw-bold py-4 rounded" style="background:#ff1493;">Total Employees: 5</div>
                        </div>
                    </div>
                    <a href="#" class="d-block mt-3 fw-bold" style="color: #16166c;" data-bs-toggle="modal" data-bs-target="#genderModal">VIEW ALL</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card shadow rounded-4">
                <div class="card-header text-white text-center fw-bold fs-5 rounded-top-4" style="background-color: #16166c;">
                    <i class="bi bi-card-checklist px-2"></i>ELIGIBILITY
                </div>
                <div class="card-body text-center">
                    <div class="row">
                        <div class="col">
                    ...
                    <a href="#" class="d-block mt-3 fw-bold" style="color: #16166c;" data-bs-toggle="modal" data-bs-target="#eligibilityModal">VIEW ALL</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card shadow rounded-4">
                <div class="card-header text-white text-center fw-bold fs-5 rounded-top-4" style="background-color: #16166c;">
                    <i class="bi bi-calendar-date px-2"></i>AGE
                </div>
                <div class="card-body text-center">
                    ...
                    <a href="#" class="d-block mt-3 fw-bold" style="color: #16166c;" data-bs-toggle="modal" data-bs-target="#ageModal">VIEW ALL</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="card shadow rounded-4">
                <div class="card-header text-white text-center fw-bold fs-5 rounded-top-4" style="background-color: #16166c;">
                    <i class="bi bi-book px-2"></i>EDUCATIONAL ATTAINMENT
                </div>
                <div class="card-body text-center">
                    <div class="row row-cols-5 g-2">
                    ...
                    <a href="#" class="d-block mt-3 fw-bold" style="color: #16166c;" data-bs-toggle="modal" data-bs-target="#educationModal">VIEW ALL</a>
                </div>
            </div>
        </div>
    </div>
